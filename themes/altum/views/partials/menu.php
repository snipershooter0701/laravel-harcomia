                ...
                <?php if (\Altum\Authentication::check()): ?>
                    ...
                    <li class="nav-item dropdown"> 
                        <a class="nav-link"  data-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false"> 
                            <img id="header-lang-img" src="<?= ASSETS_URL_PATH . 'images/countries/us.svg' ?>" alt="Header Language" height="16"> 
                        </a>
                        <div class="dropdown-menu dropdown-menu-right countries">
                            <div class="p-1 px-4">
                                <a class="dropdown-icon-item text-decoration-none" href="javascript:;">
                                    <img src="<?= ASSETS_URL_PATH . 'images/countries/us.svg' ?>" alt="user-image" class="me-1" height="12">
                                    <span class="align-middle ml-2">English</span>
                                </a>
                            </div>
                            <div class="p-1 px-4">
                                <a class="dropdown-icon-item text-decoration-none" href="javascript:;">
                                    <img src="<?= ASSETS_URL_PATH . 'images/countries/es.svg' ?>" alt="user-image" class="me-1" height="12">
                                    <span class="align-middle ml-2">Spanish</span>
                                </a>
                            </div>
                            <div class="p-1 px-4">
                                <a class="dropdown-icon-item text-decoration-none" href="javascript:;">
                                    <img src="<?= ASSETS_URL_PATH . 'images/countries/de.svg' ?>" alt="user-image" class="me-1" height="12">
                                    <span class="align-middle ml-2">Germany</span>
                                </a>
                            </div>
                            <div class="p-1 px-4">
                                <a class="dropdown-icon-item text-decoration-none" href="javascript:;">
                                    <img src="<?= ASSETS_URL_PATH . 'images/countries/it.svg' ?>" alt="user-image" class="me-1" height="12">
                                    <span class="align-middle ml-2">Italian</span>
                                </a>
                            </div>
                            <div class="p-1 px-4">
                                <a class="dropdown-icon-item text-decoration-none" href="javascript:;">
                                    <img src="<?= ASSETS_URL_PATH . 'images/countries/ru.svg' ?>" alt="user-image" class="me-1" height="12">
