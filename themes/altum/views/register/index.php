...
<form action="" method="post" class="mt-4" role="form">
    ...
    <div class="form-group mt-4">
        <input type="button" class="btn btn-primary btn-block" value="<?= l('register.form.register') ?>" onclick="userRegisterFunc()">
        <button type="submit" name="submit" class="btn btn-primary btn-block" style="display: none;" id="user_register"><?= l('register.form.register') ?></button>
    </div>
